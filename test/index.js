...
describe('download-git-repo', function () {
  ...
  var runStyle = function (type, style) {
    ...
    it(style + ' main branch by default', function (done) {
    ...
    it(style + ' main branch with specific origin', function (done) {
    ...
    it(style + ' main branch with specific origin and protocol', function (done) {
  ...
  var runType = function (type) {
    ...
    it('clones main branch with specific origin without type', function (done) {
    ...
    it('clones main branch with specific origin and protocol without type', function (done) {
  ...
  describe('via direct', function () {
    it('downloads main branch', function (done) {
    ...
    it('downloads main branch file filter', function (done) {
    ...
    it('clones main branch', function (done) {
